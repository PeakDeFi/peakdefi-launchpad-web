...
function renderLink(props) {
  return (
    <a className={classes.link} href={props.text} target="_blank" rel="noreferrer">
      <div className={classes.img}>
        <img alt="Link" src={LinkImg} />
      </div>
      <div
        className={props.isShortText ? classes.linkTextShort : classes.linkText}
      >
        {props.text}
      </div>
    </a>
...
function renderAddress(props) {
  ...
  return (
    <div className={classes.link} href={props.text}>
      <div
