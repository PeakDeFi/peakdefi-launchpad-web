...
export function TableHeader(props) {
    return (
        <div className={classes.TableHeader} style={{minWidth: "1176px"}}>
            ...
            <div style={{width: "120px", minWidth: "120px", maxWidth: "200px"}}>Current Price</div>
            <div style={{width: "80px", minWidth: "80px", maxWidth: "200px"}}>ATH</div>
            <div style={{width: "120px", minWidth: "120px", maxWidth: "200px"}}>ATH IDO ROI</div>
            <div style={{width: "150px", minWidth: "150px", maxWidth: "200px"}}>No. Participants</div>
